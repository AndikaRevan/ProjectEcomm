...
other head content must come *after* these tags -->
 ...
 <title>TikBatik</title>
 <link href="<?php echo
base_url()?>asset/bootstrap/css/bootstrap.min.css"
rel="stylesheet">
 <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
 <link href="<?php echo base_url()?>asset/asie/css/ie10-
viewport-bug-workaround.css" rel="stylesheet">
 <!-- Custom styles for this template -->
 <link href="<?php echo base_url()?>asset/custom.css"
rel="stylesheet">
...
data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
 ...
 <a class="navbar-brand" href="#"><img src="<?php echo
base_url()?>asset/logo.png"></a>
 </div>
 <div id="navbar" class="collapse navbar-collapse">
 <ul class="nav navbar-nav navbar-right">
 <li class="active"><a href="<?php echo base_url("shopping")?>">Home</a></li>
 ...
 <li><a href="<?php echo base_url()?>login"><i class="glyphicon glyphiconshopping-cart"></i> <ins>Login</ins></a></li>
 </ul>
 </div><!--/.nav-collapse -->
 </div>
 </nav>
...
class="list-group-item"><strong><i class="glyphicon glyphiconshopping-cart"></i> KERANJANG BELANJA</strong></a>
 <?php 
